...
public class ComparisonTermNeq extends ComparisonTerm {

    private final Term<Number> termA;
    private final Term<Number> termB;

    public ComparisonTermNeq(@NonNull Term<Number> termA, @NonNull Term<Number> termB) {
    ...
    public Boolean evaluate(Map<String, Object> context) {
        return !termA.evaluate(context).equals(termB.evaluate(context));
    }
