    ...
    return (
        <div className="flex flex-column gap-4">
                <Card title="Datenschutzerklärung">
                        ...
                        ihm verbundenen Webseiten, Funktionen und Inhalte auf (nachfolgend gemeinsam bezeichnet als
                        „Onlineangebot“). Im Hinblick auf die verwendeten Begrifflichkeiten, wie z.B. „Verarbeitung“
                        oder „Verantwortlicher“ verweisen wir auf die Definitionen im Art. 4 der
                        Datenschutzgrundverordnung (DSGVO).<br/><br/>

                        Verantwortlicher:<br/>
                        Oliver Ulrich Schulz<br/>
                        Adelungstraße 49<br/>
                        ...
                        <ul>
                                ...
                                <li>Nutzungsdaten (z.B., besuchte Webseiten, Interesse an Inhalten, Zugriffszeiten).
                                </li>
                        ...
                        und umfasst praktisch jeden Umgang mit Daten.<br/><br/>
                        ...
                        analysieren oder vorherzusagen.<br/><br/>
                        ...
                        von personenbezogenen Daten entscheidet, bezeichnet.<br/><br/>

                        „Auftragsverarbeiter“ eine natürliche oder juristische Person, Behörde, Einrichtung oder andere
                        Stelle, die personenbezogene Daten im Auftrag des Verantwortlichen verarbeitet.<br/><br/>
                        ...
                        dem Risiko angemessenes Schutzniveau zu gewährleisten.<br/><br/>
                        ...
                        Technikgestaltung und durch datenschutzfreundliche Voreinstellungen (Art. 25 DSGVO).<br/><br/>
                        ...
                        entsprechend Art. 15 DSGVO.<br/><br/>

                        Sie haben entsprechend. Art. 16 DSGVO das Recht, die Vervollständigung der Sie betreffenden
                        Daten oder die Berichtigung der Sie betreffenden unrichtigen Daten zu verlangen.<br/><br/>
                        ...
                        der Verarbeitung der Daten zu verlangen.<br/><br/>
                        ...
                        Verantwortliche zu fordern.<br/><br/>
                        ...
                        (andernfalls, wenn es nur dessen Cookies sind spricht man von „First-Party Cookies“).<br/><br/>
                        ...
                        Ausschluss von Cookies kann zu Funktionseinschränkungen dieses Onlineangebotes führen.<br/><br/>
                        ...
                        die aus handels- oder steuerrechtlichen Gründen aufbewahrt werden müssen.<br/><br/>
                        ...
                        Jahre gemäß § 257 Abs. 1 Nr. 2 und 3, Abs. 4 HGB (Handelsbriefe).<br/><br/>
                        ...
                        Videos), Vertragsdaten (z.B., Vertragsgegenstand, Laufzeit), Nutzungs- und Metadaten (z.B. im
                        Rahmen der Auswertung und Erfolgsmessung von Marketingmaßnahmen). Besondere Kategorien
                        personenbezogener Daten verarbeiten wir grundsätzlich nicht, außer wenn diese Bestandteile einer
                        beauftragten Verarbeitung sind. Zu den Betroffenen gehören unsere Kunden, Interessenten sowie
                        deren Kunden, Nutzer, Websitebesucher oder Mitarbeiter sowie Dritte. Der Zweck der Verarbeitung
                        besteht in der Erbringung von Vertragsleistungen, Abrechnung und unserem Kundenservice. Die
                        Rechtsgrundlagen der Verarbeitung ergeben sich aus Art. 6 Abs. 1 lit. b DSGVO (vertragliche
                        Leistungen), Art. 6 Abs. 1 lit. f DSGVO (Analyse, Statistik, Optimierung, Sicherheitsmaßnahmen).
                        Wir verarbeiten Daten, die zur Begründung und Erfüllung der vertraglichen Leistungen
                        erforderlich sind und weisen auf die Erforderlichkeit ihrer Angabe hin. Eine Offenlegung an
                        Externe erfolgt nur, wenn sie im Rahmen eines Auftrags erforderlich ist. Bei der Verarbeitung
                        der uns im Rahmen eines Auftrags überlassenen Daten handeln wir entsprechend den Weisungen der
                        Auftraggeber sowie der gesetzlichen Vorgaben einer Auftragsverarbeitung gem. Art. 28 DSGVO und
                        verarbeiten die Daten zu keinen anderen, als den auftragsgemäßen Zwecken.<br/><br/>
                        ...
                        gesetzlichen Archivierungspflichten erfolgt die Löschung nach deren Ablauf (6 J, gem. § 257 Abs.
                        1 HGB, 10 J, gem. § 147 Abs. 1 AO). Im Fall von Daten, die uns gegenüber im Rahmen eines
                        Auftrags durch den Auftraggeber offengelegt wurden, löschen wir die Daten entsprechend den
                        Vorgaben des Auftrags, grundsätzlich nach Ende des Auftrags.<br/><br/>
                        ...
                        insbesondere die Login-Informationen (Name, Passwort sowie eine E-Mailadresse). Die im Rahmen
                        der Registrierung eingegebenen Daten werden für die Zwecke der Nutzung des Nutzerkontos und
                        dessen Zwecks verwendet.<br/><br/>
                        ...
                        gespeicherten Daten des Nutzers unwiederbringlich zu löschen.<br/><br/>
                        ...
                        erfolgt grundsätzlich nicht, außer sie ist zur Verfolgung unserer Ansprüche erforderlich oder es
                        besteht hierzu besteht eine gesetzliche Verpflichtung gem. Art. 6 Abs. 1 lit. c DSGVO. Die
                        IP-Adressen werden spätestens nach 7 Tagen anonymisiert oder gelöscht.<br/><br/>
                        ...
                        beschriebenen Verfahren einverstanden.<br/><br/>
                        ...
                        protokolliert. Sofern Sie mit Ihrem Account auf der Seite eingeloggt sind, wird keine gesonderte
                        Bestätigungs-Email vesendet. Hier sorgt das vorherige Einloggen dafür, dass keine Anmeldungen
                        durch Unbefugte durchgeführt werden.<br/><br/>
                        ...
                        einer Einwilligung der Empfänger gem. Art. 6 Abs. 1 lit. a, Art. 7 DSGVO i.V.m § 7 Abs. 2 Nr. 3
                        UWG oder falls eine Einwilligung nicht erforderlich ist, auf Grundlage unserer berechtigten
                        Interessen am Direktmarketing gem. Art. 6 Abs. 1 lt. f. DSGVO i.V.m. § 7 Abs. 3 UWG.<br/><br/>
                        ...
                        möglich, sofern zugleich das ehemalige Bestehen einer Einwilligung bestätigt wird.<br/><br/>
                        ...
                        Wartungsleistungen, die wir zum Zwecke des Betriebs dieses Onlineangebotes einsetzen.<br/><br/>
                        ...
                        DSGVO i.V.m. Art. 28 DSGVO (Abschluss Auftragsverarbeitungsvertrag).<br/><br/>

                        <a href="https://datenschutz-generator.de/" target="_blank">Erstellt mit
