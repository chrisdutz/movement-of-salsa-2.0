...
public class LessonsModule implements FrontendModuleProvider {
    ...
    public List<FrontendModule> getFrontendModules() {
        return List.of(
                ...
                new FrontendModule("User", "Lessons", "fa-people", "/user/lessons", "/modules/lessons/assets/lessonsModule.js", "LessonsUserModule", 20),
                new FrontendModule("Admin", "Lessons", "fa-people", "/admin/lessons", "/modules/lessons/assets/lessonsModule.js", "LessonsAdminModule", 70),
                new FrontendModule("Admin", "Lesson Types", "fa-list", "/admin/lesson-types", "/modules/lessons/assets/lessonsModule.js", "LessonTypesAdminModule", 60));
    }
